...
export default function BottomNavbar() {
  ...
  return (
    <div className="lexend-300">
      {/* Floating Menu */}
      {isMenuOpen && (
        <div className="fixed bottom-24 left-1/2 transform -translate-x-1/2 w-[90%] max-w-sm z-40">
      ...
      <nav className="fixed bottom-5 left-1/2 transform -translate-x-1/2 w-[92%] max-w-3xl z-50">
        <div className="bg-zinc-100 dark:bg-zinc-900 text-zinc-800 dark:text-zinc-200 px-6 py-3 rounded-full flex items-center justify-between shadow-[0_8px_30px_rgb(0,0,0,0.35)] border-2 border-zinc-800 dark:border-zinc-700">
          ...
          <div className="flex items-center gap-3">
            <div className="text-lg font-black tracking-wide">⩚</div>
            <Button
              variant="ghost"
              size="icon"
              onClick={toggleMenu}
          ...
          <div className="flex items-center gap-6 text-sm font-medium">
            <Link href="#work" className="hover:text-zinc-600 dark:hover:text-zinc-400 transition">Work</Link>
            <Link href="#about" className="hover:text-zinc-600 dark:hover:text-zinc-400 transition">About</Link>
            <Link
              href="#contact"
